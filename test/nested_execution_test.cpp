...
BOOST_AUTO_TEST_CASE(nested) {
    ...
    auto execution_one =
        execution::create(stack_allocator::create(stack_size), basic_flow::make([&counter](api::disabler& dis) {
    ...
    auto execution_two = execution::create(
        stack_allocator::create(stack_size), basic_flow::make([&execution_one, &counter](api::disabler& dis) {
